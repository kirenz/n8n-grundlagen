...
4. Im leeren Canvas oben links auf den Workflow-Namen (My workflow) klicken und ihn umbenennen in **n8n-02**.
5. Neben dem Workflow-Namen auf **+ Add tag** klicken und die beiden Tags `n8n-basics` und `modul-02` erstellen und hinzufügen. Tags helfen später bei der Übersicht, Filterung und Dokumentation der Workflows.
...
4. Namen vergeben: `customer_emails` (`From scratch` auswählen).
